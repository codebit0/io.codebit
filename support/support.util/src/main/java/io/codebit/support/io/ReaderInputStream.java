 ...
 */
public class ReaderInputStream extends InputStream implements AutoCloseable, Closeable
{
	/** Input Reader class. */
	...
	/**
	 * Instantiates a new reader input stream.
	 *
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public ReaderInputStream(Reader reader, CharsetEncoder charset) throws IOException
	{
		this.reader = reader;
		pos = new PipedOutputStream();
		pis = new PipedInputStream(pos);
		osw = new OutputStreamWriter(pos, charset);
	}
